...
#define XBEE_WAKE_DELAY 1000	// Time given for XBee to initialize after powering up (ms)
XBee xbee = XBee();
XBeeAddress64 coordinatorAddress = XBeeAddress64(0x0013a200, 0x40abbade);
